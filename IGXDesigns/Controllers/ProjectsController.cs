...
namespace IGXDesigns.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,LiveLink,GitLink,GitLinkText")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,LiveLink,GitLink,GitLinkText")] Project project)
        {
            if (ModelState.IsValid)
            {
